...
| Cloudflare/Caddy route | Partially available | Caddy active on Sheldon; Cloudflare route not inspected/configured | Public hostname and access policy unknown | Loopback/LAN-only operation; route requires explicit configuration |
