...
| Freepik/Magnific or manual/MCP import produces generated candidates from approved source assets | Proven mechanically | `tests/test_phase3.py::test_phase5_manual_magnific_import_requires_approved_source_and_review`; `tests/test_phase3.py::test_phase5_web_generated_output_upload_imports_for_review`; `/creative-assets`; `docs/operating-guides/magnific-mcp-creative-assets.md`. |
