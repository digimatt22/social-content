# Copywriter Source Map

Use these sources before drafting or reviewing copy:

- `docs/business/brand-voice.md` for tone and phrasing.
- `docs/business/audiences.md` for buyer and collector context.
- `docs/business/business-goals.md` for goal selection.
